...
public class GetWords {
    ...
    public static LinkedList getAllTextsFromDirectory(String path) {
        File folder = new File(path);
        LinkedList director = new LinkedList<>();
        director.add(folder);
        LinkedList fisiere = new LinkedList<>();
        while(!director.isEmpty()){
            folder = (File) director.pop();
