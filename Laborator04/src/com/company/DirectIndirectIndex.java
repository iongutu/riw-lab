...
public class DirectIndirectIndex {
    ...
    public MultiMap<String, HashMap<String, Integer>> indexIndirect(File folder, String mapDirectFile, String inverse_map) throws IOException {
       ...
       for(String key : keys)
       {
        ...
        PrintWriter out = new PrintWriter("C:\\Users\\iongu\\Desktop\\Laboratoare\\Laborator04\\src-files\\index_indirect.txt");//salvam indexul indirect
